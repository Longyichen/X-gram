...
def test_generation_module_stop_sequences():
    ...
    generation_module.model.forward = create_mock_forward([8, 10, 99])  # type: ignore[assignment]
    ...
    generation_module.model.forward = create_mock_forward([8, 1, 99])  # type: ignore[assignment]
    output, _, _ = generation_module.generate_batch(input_ids, completions_only=False)
